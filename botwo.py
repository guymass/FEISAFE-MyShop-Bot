...
def main():
    ...
    dp.add_handler(CallbackQueryHandler(add_category, pattern='^cb_add_category$'))
    dp.add_handler(CallbackQueryHandler(handle_new_category_name, pattern='^cb_handle_new_category$'))
